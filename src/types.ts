...
export type MeaningEvaluation={block_index:number;meaning_score:number;literal_score:number;verdict:string;literal_translation:string;natural_translation:string;contextual_meaning:string;correct:string[];missing:string[];added:string[];incorrect:string[]}
