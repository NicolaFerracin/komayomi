...
export function SettingsPanel({onClose}:{onClose:()=>void}) {
  ...
  return <aside className="tool-panel settings-panel"><header><div><span className="eyebrow">LOCAL PREFERENCES</span><h2>Settings</h2></div><button className="icon-button" aria-label="Close panel" onClick={onClose}><X size={19}/></button></header>
