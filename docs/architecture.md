...
Deleting a detected text region first materializes the page's effective corrected layout, removes the selected region, and atomically clears stale index-based line and geometry edits. This prevents corrections from shifting onto a neighboring bubble after deletion.
